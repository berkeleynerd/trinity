#pragma once
#ifndef Tr2DepthStencilALOrbis_h_
#define Tr2DepthStencilALOrbis_h_
...
private:
	...
	sce::Gnm::DepthRenderTarget m_depthStencil;

	std::shared_ptr<Tr2BufferImplAL> m_zMemory;
	Tr2BufferImplAL m_stencilMemory;
