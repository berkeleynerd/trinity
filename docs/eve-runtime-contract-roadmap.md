...
| RC-13 | Add velocity and TAA | Blocked | RC-05D, RC-07, RC-12B1 | Current/previous camera, ship, attachment, Silk, and engine-effect transforms must produce valid velocity; TAA is accepted only after direct velocity visualization and cloud/engine-trail ghosting checks. |
